...
\section*{Section 3.1}
\label{sec:org041251c}
\subsection*{Problem 9}
\label{sec:orga342dda}
\begin{equation*}
...
\label{sec:org0334ce2}
\begin{align*}
  y'' + 5y' + 6y = 9, \quad y(0) = 2, \quad y'(0) = \beta,
\end{align*}
where \(\beta > 0\).
\subsubsection*{Part (a)}
\label{sec:org9823d9c}

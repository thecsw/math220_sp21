...
\section*{Section 3.1}
\label{sec:org4d1e1c0}
\subsection*{Problem 9}
\label{sec:org15f5e6f}
\begin{equation*}
...
\label{sec:org5b1c6e0}
\begin{align*}
  y'' + 5y' + 6y = 9, \quad y(0) = 2, \quad y'(0) = \beta,
\end{align*}
where \(\beta > 0\).
\subsubsection*{Part (a)}
\label{sec:orge2b3650}

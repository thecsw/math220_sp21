...
\section*{Section 3.1}
\label{sec:org0b7221c}
\subsection*{Problem 9}
\label{sec:orged59d6f}
\begin{equation*}
...
\label{sec:orgac96b39}
\begin{align*}
  y'' + 5y' + 6y = 9, \quad y(0) = 2, \quad y'(0) = \beta,
\end{align*}
where \(\beta > 0\).
\subsubsection*{Part (a)}
\label{sec:orgb9edd8e}

...
\label{sec:orgde55e87}
\begin{align*}
  y'' + 5y' + 6y = 9, \quad y(0) = 2, \quad y'(0) = \beta,
\end{align*}
where \(\beta > 0\).
\subsubsection*{Part (a)}
\label{sec:org6b20105}

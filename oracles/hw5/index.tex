...
\section*{Section 3.1}
\label{sec:orgbfe32a2}
\subsection*{Problem 9}
\label{sec:org1a483c3}
\begin{equation*}
...
\label{sec:orgb6ead54}
\begin{align*}
  y'' + 5y' + 6y = 9, \quad y(0) = 2, \quad y'(0) = \beta,
\end{align*}
where \(\beta > 0\).
\subsubsection*{Part (a)}
\label{sec:org97428e2}

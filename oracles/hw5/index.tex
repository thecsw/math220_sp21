...
\section*{Section 3.1}
\label{sec:org1ebebcc}
\subsection*{Problem 9}
\label{sec:org07fdc05}
\begin{equation*}
...
\label{sec:orgd2d833d}
\begin{align*}
  y'' + 5y' + 6y = 9, \quad y(0) = 2, \quad y'(0) = \beta,
\end{align*}
where \(\beta > 0\).
\subsubsection*{Part (a)}
\label{sec:org22bec29}

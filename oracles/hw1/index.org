...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\textwidth]{./7.pdf}
	\caption{$y' = y(4-y)$}
\end{figure}
** Problem 10
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\textwidth]{./10.pdf}
	\caption{$y' = y(y-2)^2$}
\end{figure}
** Problem 15
...
** Problem 7
   ...
   *a*. Find the time at which the population becomes extinct if $p(0)=850$
   ...
   We find that $\mu(t) = e^{\int -\sfrac{1}{2} dt} = e^{-\sfrac{1}{2}t}$. Then

   \begin{align*}
           \frac{d}{dt}(\mu(t)p) = -450 \mu(t)                                                 \\
           \implies p(t) & = \frac{\int -450\mu(t) dt}{\mu(t)}                                 \\
                         & = \frac{\int -450 e^{-\sfrac{1}{2}t}dt}{e^{-\sfrac{1}{2}t}}         \\
                         & = \frac{-450 \times (-2e^{-\sfrac{1}{2}t}) + C}{e^{-\sfrac{1}{2}t}} \\
                         & = 900 + C e^{\sfrac{1}{2}t}
   \end{align*}
   ...
   $0 = 900 - 50 e^{\sfrac{1}{2}t_e}$, where we find $t_e = \ln(324) \approx 5.78$. 

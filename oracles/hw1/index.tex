...
\section*{Chapter 1.2}
\label{sec:org5da0fcc}
\subsection*{Problem 7 [FOR GRADE]}
\label{sec:orgc43223b}
...
\section*{Chapter 1.3}
\label{sec:orga6a9e99}
\subsection*{Problem 1}
\label{sec:org556b48c}
2nd order and linear.
\subsection*{Problem 3}
\label{sec:org1a25d92}
4th order and linear.
\subsection*{Problem 5}
\label{sec:orga054120}
Plug them both in. They are solutions.
\subsection*{Problem 9}
\label{sec:org41bc9c8}
Plug them both in. They are solutions.
\subsection*{Problem 11 [FOR GRADE]}
\label{sec:org3a37aad}

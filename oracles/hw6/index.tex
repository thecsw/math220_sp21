...
\section*{Section 3.3}
\label{sec:orgcb3d3c0}
\subsection*{Problem 7}
\label{sec:orgc86e220}
\begin{align*}
  y'' + 2y' + 2y = 0
\end{align*}
...
\label{sec:orgcefefe8}
\begin{align*}
  5u'' + 2u' + 7u = 0, \quad u(0) = 2, \quad u'(0) = 1
\end{align*}
\subsubsection*{Part (a)}
\label{sec:org7162ec6}
Find that
...
\label{sec:orgbd4dafb}
\begin{align*}
  T \approx 14.512
\end{align*}
\subsection*{Problem 19}
\label{sec:org18719d7}
...
\section*{Section 3.4}
\label{sec:org7286a7b}
\subsection*{Problem 1}
\label{sec:orgf694a22}
\begin{align*}
  y'' - 2y' + y = 0
\end{align*}
Then

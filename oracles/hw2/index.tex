...
\section*{Chapter 2.1}
\label{sec:org6e10566}
\subsection*{Problem 13}
\label{sec:org359c126}
\begin{center}
\includegraphics[width=.9\linewidth]{./13.png}
\end{center}
\subsubsection*{Part a}
\label{sec:org1e8ff51}
...
\label{sec:org70a1956}
\(y\) oscillates for \(a=a_0\)
\subsection*{Problem 15 [FOR GRADE]}
\label{sec:org3ff955d}
\subsubsection*{Part a}
\label{sec:orgc9e6eac}
...
\subsubsection*{Part c}
\label{sec:orgf7308b8}
As \(t \to 0\), then \(y \to 0\). 
\subsection*{Problem 17 [FOR GRADE]}
\label{sec:org94e62ca}
...
\label{sec:orgcb0e6aa}
\subsubsection*{Part a}
\label{sec:org28ef6d1}
...
\label{sec:orgdf99fce}
\begin{equation*}
        y' = \frac{ty(4-y)}{3}, \quad y(0) = y_0
\end{equation*}
\subsubsection*{Part a}
\label{sec:org61764e1}
As \(t \to \infty\), then \(y \to 4\)
\subsubsection*{Part b}
\label{sec:org01a445f}

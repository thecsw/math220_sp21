...
\end{align*}
\section*{Section 7.1}
\label{sec:orgde5cdc9}
\subsection*{Problem 1 [FOR GRADE]}
\label{sec:org85c806e}
   Let \(u=x_{1}\).
$$
...
$$
\section*{Section 7.2}
\label{sec:org7c442a7}
\subsection*{Problem 4}
\label{sec:orgf6064eb}
